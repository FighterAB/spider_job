...
"use strict";
	...
	if (typeof define === 'function' && define.amd && define.amd.jQuery) {
		define(['myApp/static/js/jquery'], setup);
	} else {
		setup(jQuery);
	}
...
(function( factory ) {
	if (typeof define !== 'undefined' && define.amd) {
		define(['myApp/static/js/jquery'], factory);
	} else if (typeof module !== 'undefined' && module.exports) {
		var $ = require('myApp/static/js/jquery');
...
/* jquery.nicescroll 3.5.4 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */(function(e){"function"===typeof define&&define.amd?define(["myApp/static/js/jquery"],e):e(jQuery)})(function(e){var y=!1,C=!1,J=5E3,K=2E3,x=0,F=["ms","moz","webkit","o"],s=window.requestAnimationFrame||!1,v=window.cancelAnimationFrame||!1;if(!s)for(var L in F){var D=F[L];s||(s=window[D+"RequestAnimationFrame"]);v||(v=window[D+"CancelAnimationFrame"]||window[D+"CancelRequestAnimationFrame"])}var z=window.MutationObserver||window.WebKitMutationObserver||!1,G={zindex:"auto",cursoropacitymin:0,cursoropacitymax:1,cursorcolor:"#424242",
